...
function validar(){
    if(validarEmail()){
        if(validarSenha()){
            ...
            password.style.backgroundImage = 'url(/assets/invalid-password.svg)'
        ...
        email.style.backgroundImage = 'url(/assets/invalid-email.svg)'
...
function returnToNormal1(){
    ...
    email.style.backgroundImage = 'url(/assets/email.svg)'
}

function returnToNormal2(){
    password.style.borderColor = '#FFF'
    password.style.backgroundImage = 'url(/assets/password.svg)'
}
